...
function LandingPage() {
    return (
        <Grid container>
            {/* First Section */}
            <Grid container sx={{ bgcolor: '#e5ffcc', padding: '20px' }}>
                {/* Headings and Button */}
                <Grid item xs={12} md={6} sx={{ textAlign: 'center', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '10px' }}>
                    ...
                    <Button variant="contained" component={Link} to="/prediction" sx={{ backgroundColor: '#4CAF50', color: 'white', borderRadius: '20px', padding: '10px 20px', '&:hover': { backgroundColor: '#45a049' } }}>
                        Start now
                    </Button>
                </Grid>
                ...
                <Grid container item xs={12} md={6} spacing={2} sx={{ justifyContent: 'center', marginTop:'5px'}}>
                    ...
                    <Grid item xs={6} md={6}>
                        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <img src="LandingPagePic/mrt.jpg" alt="MRT image" style={{ maxWidth: '60%', height: 'auto' }} />
                            <Typography variant="body1" sx={{ marginTop: '8px', textAlign: 'center' }}>Distance to nearest MRT</Typography>
                        </Box>
                    </Grid>
                    <Grid item xs={6} md={6}>
                        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <img src="LandingPagePic/floorSize.png" alt="Floor plan image" style={{ maxWidth: '60%', height: 'auto' }} />
                            <Typography variant="body1" sx={{ marginTop: '8px', textAlign: 'center' }}>Floor size</Typography>
                        </Box>
                    </Grid>
                    <Grid item xs={6} md={6}>
                        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <img src="LandingPagePic/rooms.png" alt="Rooms image" style={{ maxWidth: '60%', height: 'auto' }} />
                            <Typography variant="body1" sx={{ marginTop: '8px', textAlign: 'center' }}>Number of rooms</Typography>
                        </Box>
                    </Grid>
                    <Grid item xs={6} md={6}>
                        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <img src="LandingPagePic/lease.png" alt="Lease image" style={{ maxWidth: '60%', height: 'auto' }} />
            ...
            {/* View Prediction History Section */}
            <Grid container spacing={2} sx={{ marginTop: '20px' }}>
                ...
                <Grid item xs={12} md={6} sx={{ textAlign: 'center', padding: '20px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'  }}>
                    ...
                    <Button variant="contained" component={Link} to="/profile" sx={{ marginTop: '10px', backgroundColor: '#4CAF50', color: 'white', borderRadius: '20px', padding: '10px 20px', '&:hover': { backgroundColor: '#45a049' } }}>
                        View
                    </Button>
                </Grid>
            </Grid>
            ...
            {/* About Us Section */}
            <Grid container sx={{ marginTop: '20px', bgcolor: '#e5ffcc', padding: '20px' }} alignItems="center">
                {/* About Us Text */}
                <Grid item xs={12} md={6} sx={{ padding: '20px', textAlign: 'center' }}>
                    ...
                    <Button variant="contained" component={Link} to="/about" sx={{marginTop: '10px', backgroundColor: '#4CAF50', color: 'white', borderRadius: '20px', padding: '10px 20px', '&:hover': { backgroundColor: '#45a049' } }}>
                        View
                    </Button>
                </Grid>
